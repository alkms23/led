...
const char* ssid     = "WIFI-Learning";  
const char* password = ""; 

const char* host = "http://ledled02.herokuapp.com/bot.php"; // ตัวอย่างเช่น http://ชื่อappของคุณ.herokuapp.com/bot.php
#define APPID   "ArduinoLED" // ชื่อ APP ID ใน NETPIE
#define KEY     "ArduinoLED" // key ของ Device Key
#define SECRET  "VFlJT53CdAxpPdHzbfhPIzcNl" // Secret ของ Device Key

#define ALIAS   "LED"  // ตั้งให้ตรงกับชื่อ อุปกรณ์ของ Device Key ใน NETPIE
